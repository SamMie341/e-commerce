  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: RefreshIndicator(
          onRefresh: () async {
            controller.fetchFavor();
          },
          color: primaryColor,
          child: Obx(() {
            if (controller.favorList.isEmpty) {
              return ListView(
                physics: AlwaysScrollableScrollPhysics(),
                children: [
                  SizedBox(height: Get.height * 0.35),
                  Center(
                      child: Text('ບໍ່ມີລາຍການທີ່ມັກ',
                ...
                itemBuilder: (context, index) {
                  ...
                  return GestureDetector(
                    ...
                    child: buildCardWidget(
                      ...
                      location: item.product.shop.name,
                      rating: num.tryParse(item.avgRating.toString()) ?? 0,
                    ),
                  );
                },
              ),
