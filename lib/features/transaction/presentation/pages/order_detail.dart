        ...
        child: Padding(
          ...
          child: Obx(
            () {
              ...
              final item = controller.orderDetail.value;
              if (item == null) {
                                ...
                                children: [
                                  TableRow(
                                    children: [
                                      ...
                                      Text(
                                        item.orderStatuses![0].user!.firstname!,
                                  ...
                                  TableRow(children: [
                                    Text('ໜ່ວຍ:'),
                                    Text(item.orderStatuses?[0].user?.unit
                                            ?.name ??
                                        ''),
                                  ]),
                                  TableRow(children: [
                                    Text('ເບີໂທຜູ້ສັ່ງຊື້: '),
                                    Text(item.orderStatuses![0].user!.tel!),
                                  ]),
                                  TableRow(
                                    children: [
                                      Text('ລວມທັງໝົດ: '),
        ...
        child: Obx(() {
          ...
          return checkStatusButton(
              ...
              onUpdateStatus: (newStatus) async {
                await shopController.acceptOrder(order!.id, newStatus,
