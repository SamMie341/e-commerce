  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: RefreshIndicator(
        ...
        child: Obx(
          () {
            if (controller.orderProcess.isEmpty) {
              return Center(
                child: Text(
            ...
            return Container(
              ...
              child: ListView.builder(
                ...
                itemCount: controller.orderProcess.length,
                itemBuilder: (context, index) {
                  final item = controller.orderProcess[index];
                  return Card(
                    elevation: 2,
                    child: Container(
                          ...
                          Row(
                            children: [
                              ...
                              Column(
                                children: [
                                  Text(
                                    item.orderDetails.last.productstatus.name,
                                    style: TextStyle(
