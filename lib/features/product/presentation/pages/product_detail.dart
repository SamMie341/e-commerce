...
class _ProductDetailState extends State<ProductDetail> {
  ...
  void initState() {
    super.initState();
    print('userCode: ${Get.arguments['userCode']}');
  }
                        ...
                        children: [
                          ...
                          Row(
                            children: [
                              Expanded(
                                child: Text(
                                  Utility.formatLaoKip(product.price),
                                  style: TextStyle(
                                      fontSize: 24,
                                      color: Colors.red,
                              ...
                              Row(
                                ...
                                children: [
                                  ...
                                  Expanded(
                                    child: Column(
                                      children: [
                                        _buildStarRatingBar(5, 12, 23),
                                        _buildStarRatingBar(4, 5, 23),
                                        _buildStarRatingBar(3, 4, 23),
                                        _buildStarRatingBar(2, 2, 23),
                                        _buildStarRatingBar(1, 0, 23),
                                      ],
                                    ),
                                  ),
                                ],
